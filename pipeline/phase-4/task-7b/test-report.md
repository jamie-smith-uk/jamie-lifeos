...
packages/shared test:  [31m❯[39m src/__tests__/env.test.ts [2m([22m[2m25 tests[22m[2m | [22m[31m7 failed[39m[2m)[22m[32m 82[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when TELEGRAM_BOT_TOKEN is missing[32m 15[2mms[22m[39m
...
packages/shared test:      [32m✓[39m throws when multiple required vars are missing and lists them all[32m 3[2mms[22m[39m
...
packages/shared test:      [32m✓[39m accepts BOT_MODE=webhook[32m 4[2mms[22m[39m
...
packages/shared test: [31m     [31m×[31m throws when STRAVA_CLIENT_ID is missing[39m[32m 11[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when STRAVA_CLIENT_SECRET is missing[39m[32m 4[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when STRAVA_REDIRECT_URI is missing[39m[32m 3[2mms[22m[39m
...
packages/shared test:  [32m✓[39m src/__tests__/migrate.test.ts [2m([22m[2m25 tests[22m[2m)[22m[32m 155[2mms[22m[39m
packages/shared test:  [32m✓[39m src/__tests__/migrate-async-await.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 7[2mms[22m[39m
packages/shared test:  [32m✓[39m src/__tests__/logger.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 63[2mms[22m[39m
...
packages/shared test: [2m   Start at [22m 06:43:44
packages/shared test: [2m   Duration [22m 775ms[2m (transform 293ms, setup 0ms, import 514ms, tests 347ms, environment 1ms)[22m
