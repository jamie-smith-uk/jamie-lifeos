...
packages/shared test:  [31m❯[39m src/__tests__/env.test.ts [2m([22m[2m25 tests[22m[2m | [22m[31m7 failed[39m[2m)[22m[32m 129[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when TELEGRAM_BOT_TOKEN is missing[32m 49[2mms[22m[39m
...
packages/shared test:      [32m✓[39m applies default BOT_MODE=polling when not set[32m 6[2mms[22m[39m
packages/shared test:      [32m✓[39m applies default LOG_LEVEL=info when not set[32m 1[2mms[22m[39m
packages/shared test:      [32m✓[39m accepts BOT_MODE=webhook[32m 3[2mms[22m[39m
packages/shared test:      [32m✓[39m throws on invalid BOT_MODE value[32m 2[2mms[22m[39m
packages/shared test:      [32m✓[39m trims leading/trailing whitespace from values[32m 1[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when STRAVA_CLIENT_ID is missing[39m[32m 12[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when STRAVA_CLIENT_SECRET is missing[39m[32m 5[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when STRAVA_REDIRECT_URI is missing[39m[32m 8[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when STRAVA_CLIENT_ID is empty string[39m[32m 3[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when STRAVA_CLIENT_SECRET is empty string[39m[32m 3[2mms[22m[39m
...
packages/shared test:      [32m✓[39m trims whitespace from Strava variables[32m 4[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws when multiple Strava vars are missing and lists them all[39m[32m 3[2mms[22m[39m
packages/shared test:  [32m✓[39m src/__tests__/migrate.test.ts [2m([22m[2m25 tests[22m[2m)[22m[32m 164[2mms[22m[39m
packages/shared test:  [32m✓[39m src/__tests__/types.test.ts [2m([22m[2m33 tests[22m[2m)[22m[32m 14[2mms[22m[39m
packages/shared test:  [32m✓[39m src/__tests__/db.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 21[2mms[22m[39m
...
packages/shared test: [2m   Start at [22m 07:03:34
packages/shared test: [2m   Duration [22m 824ms[2m (transform 361ms, setup 0ms, import 516ms, tests 414ms, environment 1ms)[22m
