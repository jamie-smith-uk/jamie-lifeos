...
packages/shared test:  [31m❯[39m src/__tests__/env.test.ts [2m([22m[2m25 tests[22m[2m | [22m[31m7 failed[39m[2m)[22m[32m 96[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when TELEGRAM_BOT_TOKEN is missing[32m 22[2mms[22m[39m
...
packages/shared test:      [32m✓[39m throws when a required var is set to empty string[32m 1[2mms[22m[39m
...
packages/shared test:      [32m✓[39m applies default BOT_MODE=polling when not set[32m 4[2mms[22m[39m
...
packages/shared test: [31m     [31m×[31m throws when STRAVA_CLIENT_ID is missing[39m[32m 14[2mms[22m[39m
...
packages/shared test: [2m   Start at [22m 06:59:10
packages/shared test: [2m   Duration [22m 830ms[2m (transform 268ms, setup 0ms, import 536ms, tests 338ms, environment 1ms)[22m
