...
packages/shared test:  [31m❯[39m src/__tests__/env-openai.test.ts [2m([22m[2m15 tests[22m[2m | [22m[31m5 failed[39m[2m)[22m[32m 77[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when OPENAI_API_KEY is missing[32m 31[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when OPENAI_API_KEY is empty string[32m 3[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when OPENAI_API_KEY is only whitespace[32m 2[2mms[22m[39m
...
packages/shared test: [31m     [31m×[31m OPENAI_API_KEY is not empty after loading[39m[32m 8[2mms[22m[39m
packages/shared test:      [32m✓[39m documents OPENAI_API_KEY in .env.example[32m 2[2mms[22m[39m
packages/shared test:      [32m✓[39m includes OPENAI_API_KEY with a value in .env.example[32m 3[2mms[22m[39m
packages/shared test:      [32m✓[39m includes an explanatory comment for OPENAI_API_KEY[32m 1[2mms[22m[39m
packages/shared test:      [32m✓[39m OPENAI_API_KEY appears near the comment in .env.example[32m 3[2mms[22m[39m
packages/shared test:      [32m✓[39m OPENAI_API_KEY is not commented out in .env.example[32m 2[2mms[22m[39m
packages/shared test:  [31m❯[39m src/__tests__/env.test.ts [2m([22m[2m25 tests[22m[2m | [22m[31m9 failed[39m[2m)[22m[32m 83[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when TELEGRAM_BOT_TOKEN is missing[32m 9[2mms[22m[39m
...
packages/shared test: [31m     [31m×[31m loads successfully when all required vars are set[39m[32m 6[2mms[22m[39m
packages/shared test: [31m     [31m×[31m applies default for ANTHROPIC_MODEL when not set[39m[32m 5[2mms[22m[39m
...
packages/shared test: [31m     [31m×[31m accepts BOT_MODE=webhook[39m[32m 3[2mms[22m[39m
packages/shared test: [31m     [31m×[31m throws on invalid BOT_MODE value[39m[32m 10[2mms[22m[39m
packages/shared test: [31m     [31m×[31m trims leading/trailing whitespace from values[39m[32m 4[2mms[22m[39m
...
packages/shared test:      [32m✓[39m throws when STRAVA_REDIRECT_URI is empty string[32m 2[2mms[22m[39m
packages/shared test: [31m     [31m×[31m loads successfully when all Strava vars are set[39m[32m 2[2mms[22m[39m
packages/shared test: [31m     [31m×[31m trims whitespace from Strava variables[39m[32m 2[2mms[22m[39m
packages/shared test:      [32m✓[39m throws when multiple Strava vars are missing and lists them all[32m 2[2mms[22m[39m
packages/shared test:  [31m❯[39m src/__tests__/db.test.ts [2m([22m[2m9 tests[22m[2m | [22m[31m9 failed[39m[2m)[22m[32m 48[2mms[22m[39m
packages/shared test: [31m     [31m×[31m exports a `pool` named export that is a pg.Pool instance[39m[32m 42[2mms[22m[39m
...
packages/shared test: [31m     [31m×[31m closePool() returns a Promise[39m[32m 1[2mms[22m[39m
packages/shared test:  [32m✓[39m src/__tests__/types.test.ts [2m([22m[2m33 tests[22m[2m)[22m[32m 23[2mms[22m[39m
packages/shared test:  [32m✓[39m src/__tests__/logger.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 74[2mms[22m[39m
...
packages/shared test: [2m   Start at [22m 10:26:47
packages/shared test: [2m   Duration [22m 877ms[2m (transform 321ms, setup 0ms, import 520ms, tests 422ms, environment 1ms)[22m
